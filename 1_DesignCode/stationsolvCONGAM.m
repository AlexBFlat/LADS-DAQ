function [outputtabl, Wdot, epsilon] = stationsolvCONGAM(gamma,R,Pcns,Tcns,Pe,Mi,F,g,epsilonc)
% Nozzle throat plane
gammat = gamma;  %
Rt = R;
...
gammainj = gamma; % Selects gamma for injector plane.
Rinj = R;         % Selects R for injector plane.
